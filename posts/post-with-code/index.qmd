...
# Aplicación para Guatepeor no guatemala

## Blanchard-Quah ortogonalización (restricciones) sobre C(1)

Hola como estas Al observar la evolución del crédito hacia consumo provisto por el sistema bancario guatemalteco y disponible en @SECMCADATOS, se observa una series con una tendendencia estocástica.
